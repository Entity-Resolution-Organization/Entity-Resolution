...
# City + state + ZIP pools for generating address component negatives
# Same street name can exist in multiple cities — teaches model that
# postcode and city are discriminating signals
CITY_STATE_ZIP_POOLS = [
    {"city": "Boston", "state": "MA", "zip": "02145"},
...
# Phonetic confusion pairs — similar sounding names that are different people
# Used for phonetic near-miss hard negatives
PHONETIC_CONFUSION_PAIRS = {
    "Garcia": ["Garsia", "Garcea", "Garcya"],
    "Smith": ["Smyth", "Smithe", "Smit"],
    "Johnson": ["Jonson", "Johnsen", "Jonsson"],
    "Williams": ["Willams", "Wiliams", "Willyams"],
    "Brown": ["Braun", "Browne", "Broun"],
    "Jones": ["Joanes", "Johnes", "Jons"],
    "Miller": ["Millar", "Muller", "Myller"],
    "Davis": ["Davies", "Davys", "Daviss"],
    "Wilson": ["Willson", "Wilsen", "Wylson"],
    "Anderson": ["Andersen", "Andersson", "Andersun"],
    "Thomas": ["Tomas", "Thomass", "Thamas"],
    "Jackson": ["Jakson", "Jaxon", "Jacksun"],
    "White": ["Whyte", "Wight", "Whit"],
    "Harris": ["Haris", "Harrys", "Hariss"],
    "Martin": ["Marten", "Martyn", "Marton"],
    "Thompson": ["Thomson", "Tompson", "Thomsen"],
    "Robinson": ["Robynson", "Robbinson", "Robenson"],
    "Clark": ["Clarke", "Clerk", "Klarke"],
    "Lewis": ["Louis", "Lewys", "Luis"],
    "Lee": ["Leigh", "Lea", "Li"],
    "Walker": ["Walkar", "Wolker", "Waker"],
    "Hall": ["Holl", "Hawl", "Hal"],
    "Allen": ["Allan", "Alen", "Allyn"],
    "Young": ["Yung", "Younge", "Yong"],
    "King": ["Kyng", "Kinge", "Kinng"],
    "Wright": ["Right", "Wryght", "Rite"],
    "Scott": ["Scot", "Skott", "Scotte"],
    "Green": ["Greene", "Grene", "Grean"],
    "Baker": ["Beker", "Bakker", "Bakar"],
    "Adams": ["Addams", "Adems", "Addems"],
    "Nelson": ["Nelsen", "Nilson", "Nelsson"],
    "Carter": ["Cartar", "Karter", "Cartor"],
    "Mitchell": ["Mitchel", "Michell", "Mitchall"],
    "Perez": ["Peres", "Perez", "Parez"],
    "Roberts": ["Robarts", "Robberts", "Robertts"],
    "Turner": ["Torner", "Turnar", "Tourner"],
    "Phillips": ["Philips", "Phillps", "Fillips"],
    "Campbell": ["Cambell", "Campbel", "Cambpell"],
    "Parker": ["Parkar", "Perker", "Parkker"],
    "Evans": ["Evens", "Evanz", "Ivans"],
    "Edwards": ["Edwerds", "Eduard", "Edwurds"],
    "Collins": ["Collens", "Colins", "Kollins"],
    "Stewart": ["Stuart", "Stewert", "Steward"],
    "Sanchez": ["Sanches", "Sanchez", "Sanchaz"],
    "Morris": ["Moris", "Morriss", "Morrice"],
    "Rogers": ["Rodgers", "Rojers", "Rogerss"],
    "Reed": ["Reid", "Read", "Rede"],
    "Cook": ["Cooke", "Kook", "Cuk"],
    "Morgan": ["Morgen", "Morgon", "Morgann"],
    "Bell": ["Bel", "Belle", "Beall"],
    "Murphy": ["Murphey", "Morphy", "Murfy"],
    "Bailey": ["Bayley", "Baley", "Bailley"],
    "Rivera": ["Riviera", "Ривера", "Rivara"],
    "Cooper": ["Couper", "Coopar", "Kuper"],
    "Cox": ["Cocks", "Kox", "Coxe"],
    "Howard": ["Howerd", "Haward", "Houard"],
    "Ward": ["Warde", "Werd", "Waard"],
    "Torres": ["Torrez", "Torez", "Tores"],
    "Peterson": ["Petersen", "Petersson", "Pettersen"],
    "Gray": ["Grey", "Grai", "Graye"],
}
